    ...
    <div class="card mt-4">
        ...
        <div class="card-body">
            ...
            <?php
                ...
                foreach($comments as $comment){
                    if($comment['id_lesson'] != $lessonShow['id']) continue;
            ...
            ?>
                <div class="mt-2">
                    <form action="./?ctl=lessons&act=subCmt&courseId=<?php echo $_GET['courseId'] . "&id=" . $lessonShow['id']; ?>" method="post">
        ...
        <div class="card-footer bg-white">
            ...
            <?php
                if(isset($_SESSION['id'])){
            ?>
            <form action="./?ctl=lessons&act=comment&courseId=<?php echo $_GET['courseId'] . "&id=" . $lessonShow['id']; ?>" method="post">
                <input type="hidden" name="id_lesson" value="<?php echo $lessonShow['id']; ?>">
                <input type="hidden" name="id_user" value="<?php echo $_SESSION['id']; ?>">
