...
<body id="body-pd" class="body-pd">
    <header class="header body-pd" id="header">
        <div class="header_toggle"> <i class='bx bx-menu bx-menu-alt-right' id="header-toggle"></i> </div>
        <div class="row">
    ...
    <div class="l-navbar show" id="nav-bar">
        <nav class="nav">
            <div> 
                <a href="./" class="nav_logo"> <i class='bx bx-layer nav_logo-icon'></i> <span class="nav_logo-name">Edu90minute</span> </a>
                <div class="nav_list"> 
            ...
            </div> <a href="./logout.php" class="nav_link"> <i class='bx bx-log-out'></i> <span class="nav_name">SignOut</span> </a>
        </nav>
    </div>
