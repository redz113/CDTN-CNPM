...
<h2 class="bg-info text-center text-uppercase mb-0 p-2">Khóa học miễn phí</h2>
			    ...
			    <div class="card">
			      ...
			      <div class="card-body">
			        ...
			        <div class="row mt-2 justify-content-center">
                        ...
                        <a href="#" class="col-auto btn btn-success m-1"><?php echo number_format($course['price'], 0, ',', '.'); ?> đ</a>
                    </div>
			      </div>
			    </div>
			  </div>
