...
<?php
    class ExercisesModel extends BaseModel
    {
        ...
        protected $tagFileInput = 'fileUpload';            //input file name
        protected $target_dir = "./uploads/files/exercises/";      //đường dẫn thư mục lưu file ảnh upload

        protected $fileType = ['pdf', 'jpg', 'png', 'git', 'webp'];       //chọn đuôi file upload
